# App para iPad y iPhone (QLab Remote Cues)

> La app nativa fue la primera versión del proyecto. Hoy la forma recomendada de usar la sala es la [web](../web/README.md); la app sigue siendo útil como mando directo contra QLab y comparte el mismo archivo de configuración.
